...
describe('c-app', () => {
    ...
    it('contains one active custom element c-greeting', () => {
        const element = createElement('c-app', {
            is: MyApp
        });
        document.body.appendChild(element);

        // Get array of c-greeting custom elements
        const greetingEls = element.shadowRoot.querySelectorAll('c-greeting');
